...
insert into tb_book (id, name, year, author, gender, created_by) values (1, 'Ritchie, Waters and Moen', 2003, 'Karim Cullen', 'Fantasia', 'admin');
insert into tb_book (id, name, year, author, gender, created_by) values (2, 'Nader, Abernathy and McClure', 2009, 'Hally Macrow', 'Suspense', 'user');